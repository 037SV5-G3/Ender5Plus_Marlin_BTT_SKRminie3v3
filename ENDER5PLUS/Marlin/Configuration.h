...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5-Plus/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, Ender-5-Plus)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 424.90 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -1.38 }
